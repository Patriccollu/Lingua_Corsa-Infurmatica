...
<br><br>
A maiò parte di sti prugrammi hè di tipu « Fonte Aperta », o 'Open Source' in inglese, o GNU, vole si dì chì _ùn ci hè nunda à pagà per impiegalli._ Certi ponu esse venduti da una sucietà ma, in stu casu, ghjè una versione, forse senza tutte e funzioni, chì si pò impiegà di rigalu.
<br><br>
...
è micca da a pagina <s>Download</s>. Perchè, da sta pagina, si scaricheghja una versione particulare cù d’altri prugrammi chì ùn sò micca sempre i benvenuti ! Osinnò ci vole à sceglie "_Show additional download options_".
...
💡 __Astuzia__ : Durante l’installazione, ci vole à sceglie a lingua _Corsican_ in a lista di e lingue pruposte è dopu ci vole à indicà _Corsu_ in e preferenze di u prugramma. Ma s’è a vi scurdate, ci hè l’[istruzzioni per installà u schedariu di lingua chì manca](https://github.com/Patriccollu/Lingua_Corsa-Infurmatica/Prughjetti/notepad/Installazione.md)

## ✨ NSIS: Nullsoft Scriptable Install System
https://nsis.sourceforge.io/MainPage  
_Prugramma per creà un assistente d’installazione o stalladore nant’à Windows per d’altri prugrammi._
...
_Ingeneratore di parolle d’entrata à l’azardu impieghendu simbulli o parolle à l’azardu. Si pò selezziunà gruppi di caratteri à impiegà per e parolle d’entrata, cum’è lettere minuscule, lettere maiuscule, cifri, è gruppi di caratteri persunnalizati. Si pò dinù definisce u furmatu di a parolla d’entrata, verificà ch’ella hè unica, caccià i caratteri simile._
...
_Lettore di ducumenti purtevule per Windows, capace di leghje i formati PDF, eBook (ePub, Mobi), XPS, DjVu, CHM, Comic Book (CBZ è CBR). Hè liberu, putente, chjucu, purtevule è si lancia in furia in furia. A priurità di a so interfaccia hè d’esse simplice à impiegà._
